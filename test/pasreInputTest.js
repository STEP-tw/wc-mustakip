...
describe("parseInput", function() {
  it('["-l","file1"]', function() {
    ...
    expectedOutput = {filePaths: ["file1"], options: ["l"]};
    assert.deepEqual(parseInput(userInput), expectedOutput);
  });

  it('["-w","file1"]', function() {
    let userInput = ["-w", "file1"];
    expectedOutput = {filePaths: ["file1"], options: ["w"]};
    assert.deepEqual(parseInput(userInput), expectedOutput);
  });

  it('["-c","file1"]', function() {
    let userInput = ["-c", "file1"];
    expectedOutput = {filePaths: ["file1"], options: ["c"]};
    assert.deepEqual(parseInput(userInput), expectedOutput);
  });
  ...
  it('["file1"]', function() {
    ...
    expectedOutput = {filePaths: ["file1"], options: ["l", "w", "c"]};
    assert.deepEqual(parseInput(userInput), expectedOutput);
  });
  it('["file1","file2"]', function() {
    let userInput = ["file1", "file2"];

    expectedOutput = {filePaths: ["file1", "file2"], options: ["l", "w", "c"]};
    assert.deepEqual(parseInput(userInput), expectedOutput);
  });
  it('["-lw","file1"]', function() {
    let userInput = ["-lw", "file1"];
    expectedOutput = {filePaths: ["file1"], options: ["l", "w"]};
    assert.deepEqual(parseInput(userInput), expectedOutput);
  });
  ...
  it('["-cl","file1"]', function() {
    ...
    expectedOutput = {filePaths: ["file1"], options: ["l", "c"]};
    assert.deepEqual(parseInput(userInput), expectedOutput);
  });
  ...
  it('["-wc","file1"]', function() {
    ...
    expectedOutput = {filePaths: ["file1"], options: ["w", "c"]};
    assert.deepEqual(parseInput(userInput), expectedOutput);
  });
